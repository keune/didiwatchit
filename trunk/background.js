...
var utils = {
    getReadableTime: function(time) {
        var t = new Date(time);
        return (utils.getTwoDigitNumber(t.getMonth() + 1)) + '.' + utils.getTwoDigitNumber(t.getDate()) + '.' + t.getFullYear() + ' ' + utils.getTwoDigitNumber(t.getHours()) + ':' + utils.getTwoDigitNumber(t.getMinutes());
    },
